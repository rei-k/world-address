...
import QRBarcodeDisplay from '../components/QRBarcodeDisplay';
      ...
      <div className="flex-between mb-6">
        <div>
          ...
          <p style={{ color: '#6b7280' }}>
            Generate and manage QR codes and barcodes for your addresses
          </p>
        </div>
      ...
      {addresses.length === 0 ? (
        <div className="card text-center" style={{ padding: '60px 40px' }}>
          ...
          <p style={{ color: '#6b7280', marginBottom: '24px' }}>
            You need to add an address first before generating QR codes and barcodes.
          </p>
        ...
        <div className="grid grid-cols-2" style={{ gap: '30px' }}>
          ...
          <div className="card">
            ...
            <div className="form-group">
              <label className="form-label">Choose an address to generate QR code or barcode</label>
              <select
            ...
            <div style={{ marginTop: '24px', padding: '16px', background: '#eff6ff', borderRadius: '6px' }}>
              ...
              <ul style={{ fontSize: '13px', color: '#1e40af', paddingLeft: '20px' }}>
                <li style={{ marginBottom: '4px' }}>QR codes and barcodes contain encrypted address tokens</li>
                <li style={{ marginBottom: '4px' }}>Your actual address is never exposed</li>
                <li style={{ marginBottom: '4px' }}>You'll be notified when someone scans your code</li>
                <li>Barcodes work with hotel check-ins and financial institutions</li>
              </ul>
            </div>
          </div>
          ...
          <div className="card">
            {selectedAddress ? (
              ...
              <div className="text-center" style={{ padding: '60px 20px' }}>
                ...
                <p style={{ color: '#6b7280' }}>
                  Select an address to generate QR code or barcode
                </p>
              </div>
            )}
          </div>
        ...
        <div className="grid grid-cols-3">
          <div>
            ...
            <p style={{ color: '#6b7280', fontSize: '14px' }}>
              Save QR codes or barcodes as PNG/SVG images for printing or sharing
            </p>
          </div>
          <div>
            <h4 style={{ fontSize: '16px', fontWeight: '600', marginBottom: '8px' }}>
            ...
            <p style={{ color: '#6b7280', fontSize: '14px' }}>
              Get real-time notifications when someone scans your QR or barcode
            </p>
          </div>
          <div>
            <h4 style={{ fontSize: '16px', fontWeight: '600', marginBottom: '8px' }}>
            ...
            <p style={{ color: '#6b7280', fontSize: '14px' }}>
              Use for hotel check-ins, financial institutions, and VeyPOS systems
            </p>
          </div>
        </div>
      </div>
